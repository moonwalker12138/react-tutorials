            ...
            <div className="row">
                <div className="col-auto">
                    <div className="d-flex flex-column justify-content-start">
                        <h2><i className="bi bi-palette" onClick={onChangeColor}></i></h2>
                        <h2><img src={img} alt="" style={{width: "32px"}}/></h2>
                        <h2><i className={`bi ${enableUseCallback ? "bi-toggle-on" : "bi-toggle-off"}`} onClick={onToggleHook}></i></h2>
                    </div>
                </div>
                <div className="col-auto ">
...
const Child: React.FC<{ callback: (img: string) => void; }> = React.memo(({ callback }) => { 
    ...
    return (
        <div style={{border: "dotted 2px", padding: "10px", width: "1050px"}}>
            <div className="d-flex justify-content-center mb-3" >
                <img src={isHare ? Hare : Tortoise} alt="" style={{opacity: 0.7, height: "400px", filter: "invert(100%)"}}/>
            </div>
            <div className="d-flex justify-content-center">
                <h2>
                    <i className="bi bi-arrow-right-circle" onClick={onClick}></i>
                </h2>
            </div>
        </div>
    );
