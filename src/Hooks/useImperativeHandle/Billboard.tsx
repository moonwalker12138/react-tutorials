    ...
    return (
        <div className="p-2" style={{ border: "solid", height: "80vh"}}>
			<div className="d-flex justify-content-end align-items-center px-1">
				<span style={{textAlign: "center", fontWeight: "bold", fontSize: "1.5rem", flex: 1}}>{"Chat"}</span>
				<img src={hare.character} alt="" style={{width: "1rem"}} className="mx-1" onClick={() => greeting(hare)}/>
				<img src={tortoise.character} alt="" style={{width: "1.4rem"}} className="mx-1" onClick={() => greeting(tortoise)}/>
				<i
			...
			<div className="d-flex justify-content-between" style={{height: "80%", overflow: "auto"}}>
				<div style={{flex: 1}}><RecordList records={getRecords()} /></div>
			</div>
        </div>
    );
});
